...
void putch (unsigned char byte)				//To transmit a Character from the Microcontroller Board to the Laptop.
{
	/* Output one byte */
...
unsigned char getch (void)					//To receive a Character from the Laptop to the Microcontroller Board.
{
	/* Retrieve one byte */
...
unsigned char getche (void)					//To transmit back a Character from the Microcontroller Board to Laptop which is received from the Laptop.
{
	unsigned char c;
